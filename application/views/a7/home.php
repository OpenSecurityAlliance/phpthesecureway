...
<header class="jumbotron subhead" id="overview">
  <div class="container">
    <h1>A7 - Insecure Cryptographic Storage</h1>
    <p class="lead">
		Many web applications do not properly protect sensitive data, such as credit cards, SSNs, and authentication 
    credentials, with appropriate encryption or hashing. Attackers may steal or modify such weakly protected data 
    to conduct identity theft, credit card fraud, or other crimes.
    </p>
  </div>
</header>
    ...
    <div class="row">
      ...
      <div class="span9">
        ...
        <section id="owasp-overview">
          ...
          <img title="Exploit - A1 - Injection" src="/assets/images/owasp-headers/a7.png" />
