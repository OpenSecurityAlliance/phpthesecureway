...
<header class="jumbotron subhead" id="overview">
  <div class="container">
    ...
    and any other automatically included authentication information, to a vulnerable web application. This allows the 
    attacker to force the victim’s browser to generate requests the vulnerable application thinks are legitimate requests from the victim.
    </p>
  </div>
</header>
    ...
    <div class="row">
      ...
      <div class="span9">
        ...
        <section id="owasp-overview">
          ...
          <img title="Exploit - A1 - Injection" src="/assets/images/owasp-headers/a5.png" />
