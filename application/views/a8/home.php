...
<header class="jumbotron subhead" id="overview">
  <div class="container">
    <h1>A8 - Failure to Restrict URL Access</h1>
    <p class="lead">
		Many web applications check URL access rights before rendering protected links and buttons. 
    However, applications need to perform similar access control checks each time these pages are accessed, 
    or attackers will be able to forge URLs to access these hidden pages anyway.
    </p>
  </div>
</header>
    ...
    <div class="row">
      ...
      <div class="span9">
        ...
        <section id="owasp-overview">
          ...
          <img title="Exploit - A1 - Injection" src="/assets/images/owasp-headers/a8.png" />
