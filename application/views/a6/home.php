...
<header class="jumbotron subhead" id="overview">
  <div class="container">
    <h1>A6 - Security Misconfiguration</h1>
    <p class="lead">
		Good security requires having a secure configuration defined and deployed for the application, frameworks, 
    application server, web server, database server, and platform. All these settings should be defined, 
    implemented, and maintained as many are not shipped with secure defaults. This includes keeping all software 
    ...
    <div class="row">
      ...
      <div class="span9">
        ...
        <section id="owasp-overview">
          ...
          <img title="Exploit - A1 - Injection" src="/assets/images/owasp-headers/a6.png" />
